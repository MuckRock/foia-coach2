...
class SourceDocumentAdmin(admin.ModelAdmin):
    list_display = ["filename", "document_title", "jurisdiction", "entity_type", "record_count", "uploaded_at"]
...
class RetentionRecordAdmin(admin.ModelAdmin):
    list_display = [
        "record_number", "record_title", "source_document",
        "minimum_retention_period", "is_permanent", "is_cross_reference", "has_embedding",
    ]
